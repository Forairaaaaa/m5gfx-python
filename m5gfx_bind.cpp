...
PYBIND11_MODULE(m5gfx, m)
{
    ...
    py::class_<LGFX>(m, "M5GFX")
        ...
        .def_static("color332", &LGFX::color332)
        .def_static("color565", &LGFX::color565)
        .def_static("color888", &LGFX::color888)
        .def_static("swap565", &LGFX::swap565)
        .def_static("swap888", &LGFX::swap888)
        .def_static("color16to8", &LGFX::color16to8)
        .def_static("color8to16", &LGFX::color8to16)
        .def_static("color16to24", &LGFX::color16to24)
        .def_static("color24to16", &LGFX::color24to16)
